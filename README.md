Homework02_Program1 is a program that allows the user to move three seek bars changing the background color. Then the user can save the color to a list. 
